...
CREATE POLICY IF NOT EXISTS tenant_isolation ON users FOR ALL
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON parties FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON fabrics FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON colors FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON rolls FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON invoices FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON invoice_lines FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
-- orders
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON orders FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON order_items FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
-- vouchers
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON vouchers FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON ledger_entries FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON cashbox_sessions FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON manual_movements FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON day_closes FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON expenses FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON returns FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON return_lines FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
-- print_jobs
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON print_jobs FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON document_sequences FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON audit_logs FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON notifications FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON settings FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
...
CREATE POLICY IF NOT EXISTS tenant_isolation ON attachments FOR ALL
  USING (tenant_id = current_setting('app.current_tenant_id')::UUID);
