    ...
    <div className="flex items-center gap-1 opacity-70 group-hover:opacity-100 transition">
      {onAdd && (
        <button
          ...
          className="inline-flex items-center gap-1 rounded-md border border-border bg-background px-2 py-1 text-[11px] font-medium text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition cursor-pointer"
        >
...
export { RowActions, SectionCard, Field };
